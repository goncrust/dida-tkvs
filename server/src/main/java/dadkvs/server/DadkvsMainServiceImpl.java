...
public class DadkvsMainServiceImpl extends DadkvsMainServiceGrpc.DadkvsMainServiceImplBase {
    ...
    public void committx(DadkvsMain.CommitRequest request,
        ...
        // we decided to process next trough consensus.
        this.server_state.main_loop.wakeup();

        // TODO if a server that is proposing a reqid stops being the leader, will this
        // reqid be undecided forever? to fix this shouldn't we propose directly from
        // the pendingTransactions list?
        while (this.server_state.i_am_leader && !paxos(reqid)) {
