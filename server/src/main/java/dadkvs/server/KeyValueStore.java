...
public class KeyValueStore {
    ...
    synchronized public boolean commit(TransactionRecord tr) {
        System.out.println("store commit read first key = " + tr.getRead1Key() + " with version = "
                + tr.getRead1Version() + "  and current version = "
        ...
        System.out.println("store commit write key  " + tr.getPrepareKey() + " with value = "
                + tr.getPrepareValue() + " and version " + tr.getTimestamp());
