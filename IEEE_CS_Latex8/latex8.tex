...
\author{Gonçalo Rua, João Gouveia, Francisco Salgueiro\\
  Instituto Superior Técnico\\ Av. Rovisco Pais 1\\ \{goncalonrua,joaotalonegouveia,mail3\}@tecnico.ulisboa.pt\\
...
\begin{abstract}
  ...
  algorithm. In this paper, we describe the system's design, overall operation,
