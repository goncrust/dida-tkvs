                ...
                case "leader":
                    ...
                    if ((parameter1.equals("on") || parameter1.equals("off")) && (parameter2 != null)) {
                        ...
                        try {
                            ...
                            ;
                            GenericResponseCollector<DadkvsConsole.SetLeaderReply> setleader_collector = new GenericResponseCollector<DadkvsConsole.SetLeaderReply>(
                                    setleader_responses, 1);
                            CollectorStreamObserver<DadkvsConsole.SetLeaderReply> setleader_observer = new CollectorStreamObserver<DadkvsConsole.SetLeaderReply>(
                                    setleader_collector);
                            ...
                            if (setleader_responses.size() >= 1) {
                                Iterator<DadkvsConsole.SetLeaderReply> setleader_iterator = setleader_responses
                                        .iterator();
                ...
                case "debug":
                    ...
                    if ((parameter1 != null) && (parameter2 != null)) {
                        try {
                            ...
                            DadkvsConsole.SetDebugRequest.Builder setdebug_request = DadkvsConsole.SetDebugRequest
                                    .newBuilder();
                    ...
                    if (parameter1 != null) {
                        try {
                            ...
                            if (configuration != old_config + 1)
                                ...
                                commit_request.setReqid(reqid).setKey1(0)
                                ...
                                if (commit_responses.size() >= responses_needed) {
                                    ...
                                    System.out
                                            .println("Reqid = " + reqid + " id in reply = " + commit_reply.getReqid());
                                    if (commit_reply.getAck()) {
                                        System.out.println("Committed key " + commit_request.getWritekey()
                                                + " with value " + commit_request.getWriteval());
                                    } else {
